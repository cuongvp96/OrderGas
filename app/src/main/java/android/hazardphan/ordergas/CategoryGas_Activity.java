...
public class CategoryGas_Activity extends AppCompatActivity implements AppBarLayout.OnOffsetChangedListener,OnMapReadyCallback {
    ...
    private TextView tv_tench,tv_diachi,tv_sdt,tv_gia;
...
//        txtTenCuaHangCategory= (TextView) findViewById(R.id.txtTenCuaHangCategory);
        ...
        btn_send = (Button) findViewById(R.id.btn_cmt_send);
        tv_tench=(TextView)findViewById(R.id.txtTenCuaHangHome);
        tv_diachi=(TextView)findViewById(R.id.txtDiaChiHome);
        tv_sdt=(TextView)findViewById(R.id.txtSDTHome);
        tv_gia=(TextView)findViewById(R.id.txtGiaTienHome);
    }
...
//        txtTenCuaHangCategory.setText(item.getTencuahang());
        ...
        tv_gia.setText(item.getMotagia());
        Glide.with(this)
                .load(item.getAnh())
                .into(coverImage);
